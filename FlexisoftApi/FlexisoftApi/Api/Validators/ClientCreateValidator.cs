...
namespace Infomil.Flexisoft.Flexisoft.FlexisoftApi.Api.Validators
{
    ...
    {
        public ClientCreateValidator(IClientsService clientsService)
        {
            CascadeMode = CascadeMode.Stop;
            var nameAllreadyUsedError = "Ce nom est déjà utilisé";

            //RuleFor(client => client.Name).Input(nameof(ClientCreateDto.Name), new ValidatorBaseSettings(true, 6, 25));
        ...
        public static List<FluentValidationRule> GetRules()
        {
            ...
            //list.Add(InputValidator.GetFluentValidationRule<ClientCreateDto>());
