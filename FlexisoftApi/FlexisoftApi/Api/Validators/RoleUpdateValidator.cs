...
namespace Infomil.Flexisoft.Flexisoft.FlexisoftApi.Api.Validators
{
    ...
    {
        public RoleUpdateValidator(IRolesService RolesService)
        {
            CascadeMode = CascadeMode.Stop;
            var nameAllreadyUsedError = "Ce nom est déjà utilisé";

            // RuleFor(Role => Role.Name).Input(nameof(RoleUpdateDto.Name), new ValidatorBaseSettings(true, 6, 25));
        ...
        public static List<FluentValidationRule> GetRules()
        {
            ...
            //list.Add(InputValidator.GetFluentValidationRule<RoleUpdateDto>());
